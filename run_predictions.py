...
class RedLightDetector: 
    ...
    def __init__(self):
        ...
        self.filter_thresholds = [0.9, 0.95, 0.9, 0.95, 0.95]
...
def downsample_image(I, scale=0.5):
...
preds = {}
for i in tqdm(range(10, len(file_names))):
    ...
    preds[file_names[i]] = rld.detect_red_light(I, display_image=True)
    # rld.detect_red_light(I, display_image=False)
